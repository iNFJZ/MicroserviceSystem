    ...
    public class EmailMessageService : IEmailMessageService
    {
        ...
        public Task PublishFileEventNotificationAsync(FileEventEmailNotification emailEvent)
        {
            ...
            if (System.Diagnostics.Debugger.IsAttached)
                ...
                Microsoft.Extensions.Logging.LoggerFactory.Create(builder => {}).CreateLogger("FileService").LogInformation($"[FileService] PublishFileEventNotificationAsync: {message}");
